...
export const campaigns: CampaignMonitor[] = [
  { id: "CMP-201", name: "Metro Spring Retail", segment: "Retail", status: "active", dbStatus: "serving", chainStatus: "active", fillRate: 93, pacing: 102, tokenPoolConsumedPct: 67, activeDevices: 1844, castImageUrl: "/mock/cmp-201-cast.png", totalTokenPool: 500000, castDurationDays: 14, tokensPerCast: 8, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-02-18T10:30:00Z", createdBy: "Lena Moreau", advertiserId: "ADV-001", startDate: "2026-03-01T00:00:00Z", submittedAt: "2026-02-15T09:00:00Z", reviewedAt: "2026-02-17T14:30:00Z", reviewedBy: "ops-admin" },
  { id: "CMP-203", name: "Launch Week Consumer Tech", segment: "Technology", status: "active", dbStatus: "serving", chainStatus: "funded", fillRate: 72, pacing: 81, tokenPoolConsumedPct: 45, activeDevices: 1092, castImageUrl: "/mock/cmp-203-cast.png", totalTokenPool: 300000, castDurationDays: 7, tokensPerCast: 12, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-03-02T14:00:00Z", createdBy: "James Chen", advertiserId: "ADV-002", startDate: "2026-03-10T00:00:00Z", submittedAt: "2026-02-28T11:00:00Z", reviewedAt: "2026-03-01T10:00:00Z", reviewedBy: "ops-admin" },
  { id: "CMP-205", name: "Luxury Travel Moments", segment: "Travel", status: "aborted", dbStatus: "paused", chainStatus: "settling", fillRate: 0, pacing: 0, tokenPoolConsumedPct: 88, activeDevices: 0, castImageUrl: "/mock/cmp-205-cast.png", totalTokenPool: 750000, castDurationDays: 30, tokensPerCast: 10, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-01-10T08:00:00Z", createdBy: "Aisha Patel", advertiserId: "ADV-003", startDate: "2026-01-20T00:00:00Z", submittedAt: "2026-01-08T15:00:00Z", reviewedAt: "2026-01-09T09:00:00Z", reviewedBy: "ops-admin" },
  { id: "CMP-208", name: "Weekend Beverage Push", segment: "FMCG", status: "active", dbStatus: "serving", chainStatus: "active", fillRate: 97, pacing: 108, tokenPoolConsumedPct: 59, activeDevices: 2101, castImageUrl: "/mock/cmp-208-cast.png", totalTokenPool: 400000, castDurationDays: 3, tokensPerCast: 15, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-04-05T16:45:00Z", createdBy: "Lena Moreau", advertiserId: "ADV-001", startDate: "2026-04-07T00:00:00Z", submittedAt: "2026-04-03T08:00:00Z", reviewedAt: "2026-04-04T16:00:00Z", reviewedBy: "ops-admin" },
  { id: "CMP-209", name: "Hyperlocal Fashion Pulse", segment: "Fashion", status: "active", dbStatus: "scheduled", chainStatus: "funded", fillRate: 18, pacing: 34, tokenPoolConsumedPct: 12, activeDevices: 286, castImageUrl: "/mock/cmp-209-cast.png", totalTokenPool: 200000, castDurationDays: 10, tokensPerCast: 6, tokenSymbol: "ADPAL", tokenNetwork: "Base", createdAt: "2026-04-01T09:15:00Z", createdBy: "Marcus Rivera", advertiserId: "ADV-004", startDate: "2026-04-12T00:00:00Z", submittedAt: "2026-03-28T14:00:00Z", reviewedAt: "2026-03-31T11:00:00Z", reviewedBy: "ops-admin" },
  { id: "CMP-211", name: "Citywide Fintech Awareness", segment: "Finance", status: "completed", dbStatus: "completed", chainStatus: "settling", fillRate: 95, pacing: 99, tokenPoolConsumedPct: 73, activeDevices: 2412, castImageUrl: "/mock/cmp-211-cast.png", totalTokenPool: 600000, castDurationDays: 21, tokensPerCast: 10, tokenSymbol: "USDC", tokenNetwork: "Arbitrum", createdAt: "2026-02-28T11:20:00Z", createdBy: "James Chen", advertiserId: "ADV-002", startDate: "2026-03-05T00:00:00Z", submittedAt: "2026-02-25T10:00:00Z", reviewedAt: "2026-02-27T09:00:00Z", reviewedBy: "ops-admin" },
  // Approved — awaiting start date
  { id: "CMP-212", name: "Summer Wellness Wave", segment: "Health", status: "approved", dbStatus: "scheduled", chainStatus: "funded", fillRate: 0, pacing: 0, tokenPoolConsumedPct: 0, activeDevices: 0, castImageUrl: "/mock/cmp-212-cast.png", totalTokenPool: 350000, castDurationDays: 14, tokensPerCast: 9, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-04-10T08:00:00Z", createdBy: "Aisha Patel", advertiserId: "ADV-003", startDate: "2026-04-20T00:00:00Z", submittedAt: "2026-04-08T11:00:00Z", reviewedAt: "2026-04-10T08:00:00Z", reviewedBy: "ops-admin", targetDeviceCount: 1800, campaignBrief: "Promote wellness supplements across urban commuter demographics during morning and evening slots." },
  { id: "CMP-213", name: "Electric Auto Launch", segment: "Automotive", status: "approved", dbStatus: "scheduled", chainStatus: "funded", fillRate: 0, pacing: 0, tokenPoolConsumedPct: 0, activeDevices: 0, castImageUrl: "/mock/cmp-213-cast.png", totalTokenPool: 800000, castDurationDays: 28, tokensPerCast: 14, tokenSymbol: "ADPAL", tokenNetwork: "Arbitrum", createdAt: "2026-04-11T15:30:00Z", createdBy: "James Chen", advertiserId: "ADV-002", startDate: "2026-04-25T00:00:00Z", submittedAt: "2026-04-09T16:00:00Z", reviewedAt: "2026-04-11T15:30:00Z", reviewedBy: "ops-admin", targetDeviceCount: 3000, campaignBrief: "Nationwide launch awareness for the NX-7 electric vehicle. High-impact creative targeting tech-savvy urban commuters." },
  // Pending review
  { id: "CMP-214", name: "Gourmet Coffee Mornings", segment: "FMCG", status: "review", dbStatus: "pending-review", chainStatus: "unfunded", fillRate: 0, pacing: 0, tokenPoolConsumedPct: 0, activeDevices: 0, castImageUrl: "/mock/cmp-214-cast.png", totalTokenPool: 180000, castDurationDays: 7, tokensPerCast: 7, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-04-12T09:00:00Z", createdBy: "Lena Moreau", advertiserId: "ADV-001", startDate: "2026-04-22T00:00:00Z", submittedAt: "2026-04-12T09:00:00Z", targetDeviceCount: 1200, campaignBrief: "Drive brand awareness for a premium single-origin coffee line. Target morning commuters in major metro areas with eye-catching E-ink visuals." },
  { id: "CMP-215", name: "Streaming Music Festival", segment: "Entertainment", status: "review", dbStatus: "pending-review", chainStatus: "unfunded", fillRate: 0, pacing: 0, tokenPoolConsumedPct: 0, activeDevices: 0, castImageUrl: "/mock/cmp-215-cast.png", totalTokenPool: 500000, castDurationDays: 5, tokensPerCast: 20, tokenSymbol: "USDC", tokenNetwork: "Base", createdAt: "2026-04-13T14:20:00Z", createdBy: "Suki Tanaka", advertiserId: "ADV-005", startDate: "2026-04-28T00:00:00Z", submittedAt: "2026-04-13T14:20:00Z", targetDeviceCount: 2500, campaignBrief: "Promote a 3-day virtual music festival. High token incentive to maximize screen time during the lead-up week. Creative features bold typography on dark background optimized for E-ink." },
  { id: "CMP-216", name: "Crypto Wallet Onboarding", segment: "Finance", status: "review", dbStatus: "pending-review", chainStatus: "unfunded", fillRate: 0, pacing: 0, tokenPoolConsumedPct: 0, activeDevices: 0, castImageUrl: "/mock/cmp-216-cast.png", totalTokenPool: 420000, castDurationDays: 21, tokensPerCast: 11, tokenSymbol: "ADPAL", tokenNetwork: "Base", createdAt: "2026-04-14T07:45:00Z", createdBy: "Marcus Rivera", advertiserId: "ADV-004", startDate: "2026-05-01T00:00:00Z", submittedAt: "2026-04-14T07:45:00Z", targetDeviceCount: 2000, campaignBrief: "User acquisition campaign for a new non-custodial crypto wallet. Emphasize security and ease-of-use messaging across tech-forward urban markets." },
];
